...
import ru.creditbank.credit.operations.jwt.JwtTrustedFilter;
...
public class SecurityConfig {
    ...
    private final JwtTrustedFilter jwtTrustedFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/credit-service/api/v1/credits/create").hasAnyRole("USER")
                        .requestMatchers("/credit-service/api/v1/credits/info/**").hasAnyRole("USER", "ADMIN", "CREDIT_MANAGER")
                        .requestMatchers("/credit-service/api/v1/credits/status/update/**").hasAnyRole("ADMIN", "CREDIT_MANAGER")
